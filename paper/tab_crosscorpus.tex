...
Stack Overflow posts                    & read    & 5{,}000 & \phantom{0}5.9\% $\pm$ 0.7 \\
Production code                         & run     & 5{,}000 & \phantom{0}4.9\% $\pm$ 0.6 \\
\addlinespace
...
\textbf{This work, 11 models pooled}    & ---     &     --- & \textbf{\phantom{0}9.0\%} \\
\textbf{Production code}                & \textbf{run} & 4{,}000 & \textbf{\phantom{0}8.9\% $\pm$ 0.9} \\
\bottomrule
\end{tabular}
