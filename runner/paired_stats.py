...
def groups_from(models: list[str], resolved) -> list[dict]:
    ...
    ARTICLE.md declines to publish a ranking and says why: only 167 of 450
    tasks separate any two of these models, and 9 of the 55 pairwise
